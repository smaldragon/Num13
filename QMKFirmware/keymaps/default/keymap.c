...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT(
        ...
        KC_LSFT,KC_Z,	KC_X,	KC_C,	KC_V,	KC_B,	KC_N,	KC_M,	KC_BSPC,			KC_1,	KC_2,	KC_3,
    ...
    [1] = LAYOUT(
        KC_ESC ,KC_GRV,	KC_E,	KC_R,	KC_T,	KC_Y,	KC_MINS,KC_EQL,	KC_LBRC,KC_RBRC,	KC_F7,	KC_F8,	KC_F9,
        KC_A,	KC_S,	KC_D,	KC_F,	KC_G,	KC_H,	KC_SCLN,KC_QUOT,KC_BSLS,KC_ENT,		KC_F4,	KC_F5,	KC_F6,
        KC_LSFT,KC_NUBS,	KC_X,	KC_C,	KC_V,	KC_B,	KC_COMM,KC_DOT,	KC_SLSH,    		KC_F1,	KC_F2,	KC_F3,
